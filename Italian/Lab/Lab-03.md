...
Introduzione	3
Eventstream Fabric	3
Attività 1. Creazione di un Eventstream	3
Attività 2. Trasformazione dell'Eventstream	7
Attività 3. Divisione dell'Eventstream e caricamento in due destinazioni	11
Aggiunta di ulteriori dati al database KQL	19
Attività 4. Convalida delle tabelle dei dati degli eventi	19
Attività 5. Creazione di collegamenti al database KQL per le tabelle delle dimensioni	20
Riepilogo	25
Riferimenti	26
...
•	Fare riferimento al post del blog per leggere l'https://aka.ms/Fabric-Hero-Blog-Ignite23annuncio completo sulla disponibilità generale di Microsoft Fabric 
•	Esplorare Fabric tramite la Presentazione guidata 
•	Iscriversi alla versione di valutazione gratuita di Microsoft Fabric 
•	Visitare il sito Web di Microsoft Fabric 
•	Acquisire nuove competenze esplorando i moduli di apprendimento di Fabric 
...
•	Blog sull'esperienza Real-Time Intelligence in Fabric 
