...
2. Fare clic sull'icona della **matita** e assegnare alla regola il nome C**licks Greater Than 30,000 **(è possibile scegliere un valore che sia più in linea con la quantità di dati trasmessi in streaming).
